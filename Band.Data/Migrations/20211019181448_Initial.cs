    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TenNhom = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NHOMNHAC", x => x.TenNhom);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebutDate = table.Column<DateTime>(type: "date", nullable: false),
                    TieuSu = table.Column<string>(type: "text", nullable: true),
                    ...
                    NhomNhacTenNhom = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
